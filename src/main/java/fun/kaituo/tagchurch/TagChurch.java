...
import fun.kaituo.tagchurch.state.ReadyState;
import fun.kaituo.tagchurch.state.WaitState;
...
public class TagChurch extends Game {
    private static TagChurch instance;
    public static TagChurch inst() { return instance; }
    ...
    public void onEnable() {
        ...
        instance = this;
        saveDefaultConfig();
        updateExtraInfo("§f教堂", getLoc("hub"));
        initScoreboard();
